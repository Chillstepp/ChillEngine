...
namespace ChillEngine::graphics::d3d12::content
{
    ...
    namespace submesh
    {
        ...
        id::id_type add(const u8*& data)
        {
            ...
            position_view.index_buffer_view.SizeInBytes = indices_buffer_size;
            ...
            element_view.element_type = element_type;
            element_view.primitive_topology = get_d3d_primitive_topology((ChillEngine::content::primitive_topology::type)primitive_topology);
