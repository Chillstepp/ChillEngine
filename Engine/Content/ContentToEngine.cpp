...
namespace ChillEngine::content
{
    namespace
    {
        ...
        public:
            ...
            u32 lod_from_threshold(f32 threshold)
            {
                ...
                if(_lod_count == 1) return 0;//single lod.
    ...
    void get_lod_offset(const id::id_type* const geometry_ids, const f32* const thresholds, u32 id_count,
                        utl::vector<lod_offset>& offsets)
    {
        assert(geometry_ids && thresholds && id_count && offsets.empty());
